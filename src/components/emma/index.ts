/**
 * EMMA Healthcare Component System
 * 
 * Central export for all EMMA healthcare components built on Material UI 5
 * with healthcare-specific design system integration.
 */

// Core EMMA Components
export { default as EMMAButton } from './EMMAButton';
